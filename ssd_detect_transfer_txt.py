...
def parse_args():
    ...
    parser.add_argument('--labelmap_file',
                        default='labelmapDianLi.prototxt')
    parser.add_argument('--model_def',
                        default='models/dianLiSsdModel/deploy.prototxt')
    parser.add_argument('--image_resize', default=1000, type=int)
    parser.add_argument('--model_weights',
                        default='/home/lk/caffe_ssd/models/dianLiSsdModel/dianLi_iter__iter_52672.caffemodel')
